  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-linear-135 from-blue-950 via-blue-900 to-blue-800 p-8 relative'>
        <div className='absolute top-0 left-0 w-full h-full'>
            ...
            <div className='absolute bottom-[20%] right-[10%] w-84 h-84 rounded-full bg-radial from-yellow-400/40 to-transparent blur-3xl animation-delay-2000'></div>
            <div className='absolute top-[45%] left-[50%] -translate-x-1/2 w-84 h-84 rounded-full bg-radial from-yellow-400/40 to-transparent blur-3xl animation-delay-3000'></div>
        </div>
        <div className='@container max-w-md w-full p-8 bg-blue-950/30 rounded-2xl shadow-[0_20px_50px_rgba(0,_29,_61,_0.7)] backdrop-blur-xl border border-blue-800/50 relative animate-fade-in'>
            ...
            <div className='relative'>
                ...
                <p className='text-blue-200 text-center mb-8'>
                    {isSignUp ? 'Joint our community today' : 'Sign in to continue your journey'}
                </p>
                <form className='mt-8 space-y-5 perspective-10000'>
                    {isSignUp && (
                        <div className='group'>
                   ...
                   <button className='group w-full p-4 mt-6 bg-gradient-to-r from-yellow-500 to-yellow-400 text-blue-950 rounded-xl font-bold shadow-lg hover:shadow-yellow-400/40 overflow-hidden transform transform-style-3d hover:-translate-y-.5 hover:scale-105 hover:translate-z-20 transition-all duration-300 relative'>
                        ...
                        <span className='absolute insert-0 bg-gradient-to-r from-yellow-500 to-yellow-300 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none'>
